...
output.write("proceed = True\n")
output.write("while proceed:\n   #setja upp valmynd\n")#setja upp loop
...
for x in range(valmyndir-1):
    output.write("    elif liður == '%i':\n        'placeholder svo það komi ekki error'# cóði fyrir lið %i\n" % (x+2, x+2))#gera elif statemenst fyrir alla hina liðina
output.write("    elif liður == 'exit': proceed = False# exit condition")